...
- Run "***docker run -it --rm --entrypoint bash srsc58172-58360***" to run the image created on a docker environment
- Run "***java -cp FServer-0.0.1-jar-with-dependencies.jar com.srsc5817258360.proj2.client.FClientShell***" to run the client shell program
